...
#获取测试数据
test_data=DoExcel(project_path.test_cases_path,'invest').get_data()
#全局变量
COOKIES=None
...
class TestApi(unittest.TestCase):
    def setUp(self):
        self.t=DoExcel(project_path.test_cases_path,'invest')#创建一个Excel操作实例
    ...
    def test_api(self,data_item):
        ...
        self.logger.info("测试数据是:{0}".format(param))
