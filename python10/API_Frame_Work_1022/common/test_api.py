...
sheet_name=ReadConfig().read_config(project_path.case_config_path,'CASECONFIG','sheet_name')
#获取测试数据
test_data=DoExcel(project_path.test_cases_path,sheet_name).get_data(button,case_id_list)
...
class TestApi(unittest.TestCase):
    def setUp(self):
        self.t=DoExcel(project_path.test_cases_path,sheet_name)#创建一个Excel操作实例
